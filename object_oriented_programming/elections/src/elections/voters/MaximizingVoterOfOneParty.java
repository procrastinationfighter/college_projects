 ...
 */
public class MaximizingVoterOfOneParty extends MaximizingVoter {
     ...
     */
    public MaximizingVoterOfOneParty(String name, String surname, int traitIndex, Party favouriteParty) {
